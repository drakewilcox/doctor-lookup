export class DoctorSearch {
  async getDoctor() {
    try {
      ...
      'https://api.betterdoctor.com/2016-03-01/doctors?first_name=xavier&last_name=preciado&query=medical&location=or-portland&gender=male&skip=0&limit=10&user_key=${process.env.API_KEY}'
